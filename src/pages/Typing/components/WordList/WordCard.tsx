...
function renderTranslation(trans: string) {
  return trans.includes('<ruby>') ? <span dangerouslySetInnerHTML={{ __html: trans }} /> : trans
}
  ...
  return (
    ...
    >
      <div className="flex-1">
        ...
        <div className="mt-2 max-w-sm break-words font-sans text-sm text-gray-400">{renderTranslation(word.trans.join('；'))}</div>
      </div>
